    ...
    (function( $, window, undefined ) {
        ...
        $.extend( $.mobile, {
            ...
            resetActivePageHeight: function( height ) {
                ...
                page.css("min-height", $(document.body).height() - (pageOuterHeight - pageHeight));
                //page.css("min-height", height - (pageOuterHeight - pageHeight) + (document.body.style.zoom * (pageOuterHeight - pageHeight)));
            },
