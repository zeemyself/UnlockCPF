...
session_start();
//print_r($_SESSION);
if($_SESSION['usertype']=='1'||$_SESSION['usertype']=='g'){ // à¸šà¸¸à¸„à¸„à¸¥à¸—à¸±à¹ˆà¸§à¹„à¸›
	$typeofuser = "X";
...
if($opsys_client=='1'||$_SESSION['opsys_client']=='1'){ // dv1 200
	$url= "http://cpfdv1.cpf.co.th:8000/sap/bc/srt/rfc/sap/zws_reset_unlock_psw?sap-client=200&wsdl=1.1";
	$login_wsdl = 'wsrfc';
	$pw_wsdl = 'cpfWS@10';
	$Client = "DV1-200";
}
else if($opsys_client=='2'||$_SESSION['opsys_client']=='2'){ // dv1 210
	$url= "http://cpfdv1.cpf.co.th:8000/sap/bc/srt/rfc/sap/zws_reset_unlock_psw?sap-client=210&wsdl=1.1";
	$login_wsdl = 'wsrfc';
	$pw_wsdl = 'cpfWS@10';
	$Client = "DV1-210";
}
else if($opsys_client=='3'||$_SESSION['opsys_client']=='3'){ // dv1 220
	$url= "http://cpfdv1.cpf.co.th:8000/sap/bc/srt/rfc/sap/zws_reset_unlock_psw?sap-client=220";
	$login_wsdl = 'wsrfc';
	$pw_wsdl = 'cpfWS@10';
	$Client = "DV1-220";
}
else if($opsys_client=='4'||$_SESSION['opsys_client']=='4'){ // dv1 230
	$url= "http://cpfdv1.cpf.co.th:8000/sap/bc/srt/rfc/sap/zws_reset_unlock_psw?sap-client=230";
	$login_wsdl = 'wsrfc';
	$pw_wsdl = 'cpfWS@10';
	$Client = "DV1-230";
}
else if($opsys_client=='5'||$_SESSION['opsys_client']=='5'){ // dv1 240
	$url= "http://cpfdv1.cpf.co.th:8000/sap/bc/srt/rfc/sap/zws_reset_unlock_psw?sap-client=240";
	$login_wsdl = 'wsrfc';
	$pw_wsdl = 'cpfWS@10';
	$Client = "DV1-240";
}
