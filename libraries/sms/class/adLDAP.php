...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@cpf.co.th";
    ...
    * @var string
    */
	protected $_base_dn = "DC=cpf,DC=co,DC=th"; 
    ...
    */
	...
	protected $_domain_controllers = array ("VTDC-DC02.cpf.co.th");
    ...
    */
    public function user_info($username,$fields=NULL,$isGUID=false){
	 ...
	 /**
	* Create by Wisanu T.
    * Find information about the users by pager
    * 
    * @param string $username The username to query
    * @param array $fields Array of parameters to query
    * @param bool $isGUID Is the username passed a GUID or a samAccountName
    * @return array
    */
    public function user_info_bpager($pager,$fields=NULL){
        ...
        return false;
		 ...
		 /**
	* Create by Wisanu T.
    * Find information about the users by Display name  (English full name)
    * 
    * @param string $username The username to query
    * @param array $fields Array of parameters to query
    * @param bool $isGUID Is the username passed a GUID or a samAccountName
    * @return array
    */
    public function user_info_bfixeddisplayname($displayname,$fields=NULL){
        if ($displayname===NULL){ return (false); }
        if (!$this->_bind){ return (false); }

		/*fixed full displayname*/
        ...
        return false;
			 ...
			 /**
	* Create by Wisanu T.
    * Find information about the users by descriptin  (Thai full name)
    * 
    * @param string $username The username to query
    * @param array $fields Array of parameters to query
    * @param bool $isGUID Is the username passed a GUID or a samAccountName
    * @return array
    */
    public function user_info_bfixeddescription($description,$fields=NULL){
   ...
   function generatePassword(){
        $firstchar = substr(str_shuffle("ABCDEFGHJKLMNPQRSTUVWXYZ"), 0, 4);
        $secondchar = substr(str_shuffle("*#$@"),0,1);
        $thirdchar = substr(str_shuffle("0123456789"),0,4);
        return $firstchar . $secondchar . $thirdchar;
    }
    
    
	#Increase by wisanu.sys
